    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#0a2d20] to-[#0a2d20] flex flex-col items-center justify-center px-4">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-[11px] text-[#9c7e2e] font-semibold tracking-widest uppercase mt-1">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 max-w-md w-full">
          ...
          <div className="flex flex-col items-center justify-center py-6">
            <div className="w-12 h-12 rounded-full border-4 border-[#f0e0a0] border-t-[#9c7e2e] animate-spin mb-6" />
            ...
            {data?.status === "awaiting_payment" && (
              <p className="text-xs font-medium text-[#1db5b5] mt-3">
        ...
        <div className="fixed bottom-0 left-0 right-0 z-50 p-5 no-print animate-slide-up">
          <div className="max-w-2xl mx-auto bg-gradient-to-r from-[#0a3d2e] to-[#0a2d20] rounded-2xl shadow-2xl border border-[#1db5b5]/40 p-5 relative">
            ...
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#1db5b5]/20 flex items-center justify-center mt-0.5">
                <CheckCircle className="h-5 w-5 text-[#1db5b5]" />
              </div>
              <div className="flex-1 min-w-0">
                ...
                {resendResult === "success" && (
                  <p className="text-[#1db5b5] text-xs mt-1 font-medium">Resent successfully.</p>
                )}
                {resendResult === "error" && (
              ...
              <button
                ...
                disabled={resending}
                className="flex-shrink-0 text-xs text-[#1db5b5] border border-[#1db5b5]/40 px-3 py-1.5 rounded-lg hover:bg-[#1db5b5]/10 transition-colors disabled:opacity-50 whitespace-nowrap"
              >
          ...
          <div className="max-w-2xl mx-auto bg-gradient-to-r from-[#0a2d20] to-[#0a2d20] rounded-2xl shadow-2xl border border-[#9c7e2e]/30 p-5 relative">
            ...
            {emailSent ? (
              <div className="flex items-center gap-3 justify-center py-2">
                <CheckCircle className="h-6 w-6 text-[#1db5b5]" />
                <p className="text-white font-semibold">Report sent! Check your inbox.</p>
              </div>
            ) : emailShowCounterPrompt ? (
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#9c7e2e]/20 flex items-center justify-center">
                    <FileText className="h-5 w-5 text-[#9c7e2e]" />
                  </div>
                  <div>
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#9c7e2e]/20 flex items-center justify-center">
                    <Mail className="h-5 w-5 text-[#9c7e2e]" />
                  </div>
                  <div>
                ...
                <div>
                  <input
                    ...
                    className="w-full rounded-lg border border-white/20 bg-white/10 text-white placeholder-gray-500 px-4 py-2.5 text-sm focus:border-[#9c7e2e]/60 focus:ring-1 focus:ring-[#9c7e2e]/40 outline-none"
                  />
          ...
          <div className="flex items-start sm:items-center justify-between gap-3 flex-wrap">
            <div className="min-w-0">
              ...
              {data.employerType && data.employerType !== "Unknown" && (
                <p className="text-[#9c7e2e] font-medium mt-1 text-sm sm:text-base truncate">Analysis: {data.employerType} Contract</p>
              )}
            </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 flex gap-6">
        ...
        <div className="flex-1 min-w-0 space-y-6">
          ...
          {priorities.length > 0 && (() => {
            ...
            return (
            <div id="priority-card" className="bg-white rounded-xl shadow-md border-l-4 border-[#9c7e2e] p-4 sm:p-6 print-section scroll-mt-24">
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  <p className="text-[#9c7e2e] text-sm font-semibold uppercase tracking-wide mb-1">
                ...
                <ul className="space-y-1">
                  {naPrinciples.map((p: any, i: number) => (
                    <li key={i} className="text-sm text-gray-600 flex items-start gap-2">
                      <span className="text-[#9c7e2e]">-</span> {typeof p === "object" ? JSON.stringify(p) : p}
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1">
                  {naPrioritizedAsks.map((ask: any, i: number) => (
                    <li key={i} className="text-sm text-gray-600 flex items-start gap-2">
                      <span className="text-[#9c7e2e] font-bold">{i + 1}.</span> {typeof ask === "object" ? (ask?.ask ?? ask?.item ?? ask?.description ?? JSON.stringify(ask)) : ask}
                    </li>
                  ))}
                </ul>
              </div>
                    ...
                    {!startDateConfirmed && !startDateSkipped ? (
                      <div>
                        ...
                        <input
                          ...
                          className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm mb-2 focus:outline-none focus:ring-2 focus:ring-[#9c7e2e]"
                        />
                        <div className="flex gap-2">
                          <button
          ...
          <div id="contract-chat" className="bg-white rounded-xl shadow-md p-4 sm:p-6 no-print scroll-mt-24">
            ...
            >
              <div className="flex items-center gap-3">
                <MessageCircle className="h-5 w-5 text-[#1db5b5]" />
                <div className="text-left">
                ...
                {chatQuestionsRemaining > 0 ? (
                  <div className="flex gap-2">
                    <textarea
                      ...
                      rows={1}
                      className="flex-1 rounded-lg border border-gray-300 px-4 py-2.5 text-base sm:text-sm focus:border-[#1db5b5] focus:ring-1 focus:ring-[#1db5b5] outline-none resize-none"
                    />
                    <button
