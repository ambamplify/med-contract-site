      ...
      const qaHtmlBody = transcript.map((m) => {
        ...
        return `
          <div style="margin:0 0 1.25rem; padding:0 0 1rem; border-bottom:1px solid #e5e7eb;">
            <p style="font-size:0.7rem; font-weight:700; letter-spacing:0.12em; text-transform:uppercase; color:${isUser ? "#0a2d20" : "#9c7e2e"}; margin:0 0 0.5rem;">${isUser ? "Question" : "MedContractIntel"}</p>
            <p style="color:${isUser ? "#0a2d20" : "#374151"}; font-size:0.9375rem; line-height:1.6; margin:0; ${isUser ? "font-weight:600;" : ""}">${escape(m.content)}</p>
          </div>`;
      }).join("");
      const html = `
        <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif; max-width:640px; margin:0 auto; padding:2rem 1rem; color:#1f2937; background:#f9fafb;">
          <div style="background:#0a2d20; border-radius:12px 12px 0 0; padding:1.5rem 2rem; text-align:center;">
          ...
          <div style="background:#ffffff; padding:2rem; border:1px solid #e5e7eb;">
            <p style="color:#0a2d20; font-size:1rem; margin:0 0 1.25rem;">Below is your full Q&amp;A session for analysis #${id}.</p>
            ${qaHtmlBody}
          ...
          <div style="background:#0a2d20; border-radius:0 0 12px 12px; padding:1rem 2rem; text-align:center;">
    ...
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
        ...
        <tr><td style="background:#ffffff;padding:2rem;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;">
          <p style="color:#0a2d20;font-size:1.125rem;font-weight:700;margin:0 0 1rem;">Your MedContractIntel Calculator Results</p>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#f9fafb;border-radius:8px;border:1px solid #e5e7eb;margin-bottom:1.5rem;">
            ${effectiveHourly ? `<tr><td style="padding:0.875rem 1rem;border-bottom:1px solid #e5e7eb;">
              ...
              <span style="color:#0a2d20;font-weight:700;font-size:1rem;">${fmt(effectiveHourly)}</span>
            </td></tr>` : ""}
            ...
            ${groupRevenue ? `<tr><td style="padding:0.875rem 1rem;">
              ...
              <span style="color:#0a2d20;font-weight:700;font-size:1rem;">${fmt(groupRevenue)}</span>
            </td></tr>` : ""}
          </table>
