    ...
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
        ...
        <tr><td style="background:#ffffff;padding:2rem;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;">
          <p style="color:#1f6e43;font-size:1rem;margin:0 0 1rem;">Hi ${firstName},</p>
          ...
          <p style="color:#374151;font-size:0.9375rem;line-height:1.7;margin:0 0 1.5rem;">
            <strong style="color:#1f6e43;">${productName}</strong> — open the ${isBundle ? "attachments" : "attachment"} below to get started.
          </p>
